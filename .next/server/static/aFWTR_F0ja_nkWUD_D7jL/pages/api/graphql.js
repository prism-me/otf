...
var root = {
  blogs: _database_blog_database__WEBPACK_IMPORTED_MODULE_2__["BlogsData"]
};
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  const query = req.body.query;
  const response = await Object(graphql__WEBPACK_IMPORTED_MODULE_1__["graphql"])(schema, query, root);
  return res.end(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(response));
});
