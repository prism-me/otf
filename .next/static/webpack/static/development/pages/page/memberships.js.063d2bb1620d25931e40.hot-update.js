...
var Nav = function Nav() {
  ...
  return __jsx("div", {
    ...
    return __jsx("li", {
    ...
    }, console.log("menuitem", menuItem), menuItem.type === 'sub' ? __jsx("a", {
      className: "dropdown",
      href: "/page/locations",
      ...
      href: menuItem.path,
      className: "".concat(menuItem.active === true ? 'active' : ''),
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 100,
...
//# sourceMappingURL=memberships.js.063d2bb1620d25931e40.hot-update.js.map