...
var Nav = function Nav() {
  ...
  return __jsx("div", {
    ...
    return __jsx("li", {
    ...
    }, console.log(menuItem), menuItem.type === 'sub' ? __jsx("a", {
      className: "dropdown",
      href: "/page/locations",
      ...
      href: menuItem.path,
      className: "".concat(menuItem.active = true ? 'active' : undefined),
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 101,
...
//# sourceMappingURL=memberships.js.f2fb2546405e13f6266d.hot-update.js.map