...
var Nav = function Nav() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    document.querySelector(".navbar .main-menu .navItemStyle .navItemLink").classList.add("active");
    return function () {
      document.querySelector(".navbar .main-menu .navItemStyle .navItemLink").classList.remove("active");
    };
  }, []);
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
  ...
  return __jsx("div", {
    ...
    return __jsx("li", {
      ...
      href: menuItem.path,
      className: "navItemLink" // className={`${menuItem.active ? 'active' : ''}`}
      ,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=memberships.js.c62abbbe1f7926ccf013.hot-update.js.map